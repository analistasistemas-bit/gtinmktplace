...
export function PreviewKit({ n, base, value, onChange }: {
  n: number;
  base: BaseParaKit;
  ...
  return (
    <div className="flex flex-col gap-3 rounded-lg border p-3">
      <span className="text-sm font-medium">Kit de {n} unidades</span>

      <div className="flex flex-col gap-1">
        <label htmlFor={id('titulo')} className="text-xs text-muted-foreground">
          Título
          <span className={cn('ml-1', tituloExcedeu ? 'text-destructive' : 'text-muted-foreground')}>
      ...
      <div className="flex flex-col gap-1">
        <span className="text-xs text-muted-foreground">Foto<span className="text-destructive"> *</span></span>
