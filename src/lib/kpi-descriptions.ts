...
export const KPI_DESCRIPTIONS: Record<string, string> = {
  ...
  'Markup no período':
    '(Líquido recebido − imposto − custo) ÷ custo, onde o líquido já vem descontado de comissão do Mercado Livre e frete pago pelo vendedor. Calculado sobre o total do período: soma dos líquidos menos soma dos custos, dividido pela soma dos custos. Só entram vendas com custo cadastrado.',
  Compradores:
  ...
  'Lucro no período':
    'Líquido menos custo dos produtos vendidos, somado sobre as vendas do período com custo cadastrado. O líquido já vem descontado de comissão do Mercado Livre e frete pago pelo vendedor — o imposto não está descontado aqui.',
  'Saúde dos anúncios':
  ...
  Markup:
    '(Líquido recebido − imposto − custo) ÷ custo, onde o líquido já vem descontado de comissão do Mercado Livre e frete pago pelo vendedor. Calculado sobre o total do período: soma dos líquidos menos soma dos custos, dividido pela soma dos custos. Só entram pedidos com custo cadastrado.',
