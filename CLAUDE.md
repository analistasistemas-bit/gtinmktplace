...
**Status do projeto:** M0+M1+M2+M3+M3.1 ✅ concluídos; M4 (Integração ML) em andamento — **OAuth ✅** + **busca de concorrência ✅** + **estratégia de preço condicional ✅** (ADR-0008, process-familia v16); próximos blocos do M4: categorias/atributos, publicação CREATE/UPDATE
