...
| Atributos obrigatórios (closed-set + numérico + texto-livre) | `_shared/ai/atributos-llm*.ts` | closed-set: escolhe `value_id` da lista; numérico: extrai do texto; texto-livre obrigatório: infere do nome/descrição SÓ se as palavras constarem na fonte (ADR-0052, nunca inventa) |
