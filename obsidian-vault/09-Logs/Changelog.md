...
- **Auditoria `improve` nova (rodada 3) na superfície de mensagens pós-venda (ADR-0067/0068)** — sem
  ...
  - **Pendência de operador**: plano 038 (design de liveness de integração, spike 032 → ADR) e o
    plano 039 resultante seguem TODO — dependem de decisão do Diego sobre as 4 questões abertas do
    spike.
