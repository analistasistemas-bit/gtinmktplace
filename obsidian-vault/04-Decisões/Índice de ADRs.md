...
| 0156 | [Carteira agregada, pendências de cobrança e alíquota explícita na central](../../docs/decisions/0158-central-carteira-agregada-e-pendencias.md) — ação `wallet` única, pendência = bloqueio da prévia, catálogo de custo por RPC, alíquota nunca presumida; corrige o contrato de `platform_resolve_terms`. |
