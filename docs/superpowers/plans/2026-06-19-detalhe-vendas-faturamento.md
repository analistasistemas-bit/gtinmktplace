...
- Create `src/lib/__tests__/detalhe-vendas.test.ts`.
...
Crie `src/lib/__tests__/detalhe-vendas.test.ts`:
...
Run: `npx vitest run src/lib/__tests__/detalhe-vendas.test.ts`
...
```bash
git add src/lib/detalhe-vendas.ts src/lib/__tests__/detalhe-vendas.test.ts
...
Crie `src/components/__tests__/dashboard-publicados.test.tsx`:
...
import { DashboardPublicados } from '../dashboard-publicados';
...
Run: `npx vitest run src/components/__tests__/dashboard-publicados.test.tsx`
...
- Modify: `src/App.tsx`
- Test: `src/pages/__tests__/detalhe-vendas-page.test.tsx` (create)
...
Crie `src/pages/__tests__/detalhe-vendas-page.test.tsx`:
...
import DetalheVendas from '../DetalheVendas';
...
Run: `npx vitest run src/pages/__tests__/detalhe-vendas-page.test.tsx`
...
```bash
git add src/pages/DetalheVendas.tsx src/App.tsx src/pages/__tests__/detalhe-vendas-page.test.tsx
