...
| **Garimpo (de sortimento)** | A decisão que o Sonar serve: "vale cadastrar este produto?" — respondida com demanda (visitas 30d, ranking, termos em alta), barreira competitiva (ofertas, vendedores, frete grátis) e margem simulada com custo hipotético informado pelo operador. Acontece ANTES de existir planilha. |
