...
| **Preço mínimo (piso)** | `variacoes.preco`. Valor informado pelo operador — coluna `PRECO` da planilha ou campo "Preço mínimo" do cadastro manual. NÃO é necessariamente o preço publicado: é o piso abaixo do qual o anúncio não sai. Exibido na Revisão como "mín. líquido" e usado como `piso` pelo `SemaforoPreco` (ADR-0020). |
