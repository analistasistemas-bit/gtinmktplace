...
| 8 | Aviso de lead no Telegram | — | ✅ 25/09/2026 — `_webhook` do FormSubmit chama a edge `lead-landing-telegram`, que avisa no Telegram do Diego via bot dedicado `@Publiai_leads_bot` (ver `docs/reference/edge-functions.md`). Best-effort: se falhar, o e-mail continua chegando |
