...
**Data:** 2026-08-12
**Status:** aceito — **superado parcialmente pelo [ADR-0135](0135-cadastro-fiscal-e-faturador-do-ml.md)** (2026-08-25).
A pesquisa da API fiscal do ML mostrou que o Faturador do próprio ML (grátis) cobre transmissão,
certificado e série — D-3, D-6 e D-8 deste ADR não serão implementados. As decisões de **dado**
(D-2, D-10, D-11, D-14) permanecem válidas e foram absorvidas pelo ADR-0135.
*(Status anterior: aceito, implementação pausada por dependência externa, 2026-08-12.)*
