...
**Status:** **Abandonado em 2026-08-29.** A JoomPulse passou a cobrar pelo `client_id` OAuth em condições que Diego recusou, e sem ele nenhum login é possível (Errata 5: o provedor recusa o cliente antes de resolver o Client ID Metadata Document). A funcionalidade **não** foi cancelada — mudou de fonte: a inteligência de mercado passa a ser própria, sobre Apify e API do ML. Ver [Spike 043](../spikes/043-como-a-joompulse-estima-vendas.md) (o método deles era `GMV ÷ preço`, não contagem), [Spike 044](../spikes/044-vendas-mensais-sem-joompulse.md) (a fonte substituta, validada em produção) e o ADR-0141 (o desenho do relatório, emendado). Todo o Gateway descrito abaixo foi removido do repositório e da infraestrutura; o texto fica como registro do que foi medido
**Data:** 2026-08-23
**Decisores:** Diego
