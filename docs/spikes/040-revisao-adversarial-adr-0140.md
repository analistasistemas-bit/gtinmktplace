...
| C-2 | **Linha 137 × linha 145.** A ADR diz "Cobertura: medida em 2026-08-29" e, sete linhas abaixo, "A cobertura real (...) **também não foi medida**". Resíduo pré-Spike 039. **Corrigido nesta entrega.** |
...
| C-5 | **D-27 × política publicada da JoomPulse.** A §7 da política de privacidade diz: "Você pode desconectar o cliente de IA da sua conta JoomPulse a qualquer momento (...) **A desconexão revoga as credenciais de acesso anteriormente emitidas**." A D-27 adota "revogação remota é inexistente até prova em contrário" porque o suporte não soube informar. O documento público diz o contrário do suporte. A UI da D-27 avisaria o cliente de algo que o fornecedor promete não acontecer. |
