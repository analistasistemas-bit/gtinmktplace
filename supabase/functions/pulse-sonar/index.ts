...
// Item mais barato da ficha (proxy do ganhador) — usado nas visitas (abaixo).
...
Deno.serve(async (req) => {
  ...
  // `criado_em` (D9, Grupo C) existiu nesta mesma v3 e foi removido (sonda desligada de vez, 403
  // no multiget de terceiros — ver D9 revisado) sem bump novo: campo opcional que ninguém mais lê
  // some sozinho quando o cache antigo expirar em até 24h.
