...
/** Lê as credenciais/flag do Telegram do usuário (tabela configuracoes). */
export async function lerConfigTelegram(admin: SupabaseClient, userId: string): Promise<ConfigTelegram> {
