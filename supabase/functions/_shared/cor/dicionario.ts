...
export const DICIONARIO_CORES: CorCanonica[] = [
  ...
  { canonica: 'Amarelo Canário', sinonimos: ['amarelo canário', 'amarelo canario'] },
  ...
  { canonica: 'Rosa Pink', sinonimos: ['rosa pink'] },
  { canonica: 'Pink', sinonimos: ['pink'] },
  { canonica: 'Roxo', sinonimos: ['roxo', 'roxa'] },
  { canonica: 'Roxo Médio', sinonimos: ['roxo médio', 'roxo medio'] },
  ...
  { canonica: 'Champagne', sinonimos: ['champagne'] },
  { canonica: 'Marfim', sinonimos: ['marfim', 'marfin'] },
  { canonica: 'Cru', sinonimos: ['cru', 'crua', 'natural'] },
  { canonica: 'Cinza', sinonimos: ['cinza'] },
  { canonica: 'Cinza Claro', sinonimos: ['cinza claro'] },
  { canonica: 'Cinza Médio', sinonimos: ['cinza médio', 'cinza medio'] },
