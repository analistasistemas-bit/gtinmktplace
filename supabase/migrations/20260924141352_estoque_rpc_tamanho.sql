...
-- `tem_tamanho` do resumo roda uma subconsulta por produto sobre a última família PUBLICADA
-- (mesma que adicionar-variacoes-familia clona); `familias` só tinha índice por (user_id, codigo_pai).
